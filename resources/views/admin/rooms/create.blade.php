            ...
            <div class="mb-6 grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select 
                        ...
                        required
                    >
                        @foreach(\App\Enums\Currency::options() as $value => $label)
                            <option value="{{ $value }}" @if(old('currency', isset($room) ? $room->currency->value : 'USD') === $value) selected @endif>
                                {{ $label }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="mb-8">
                <label class="flex items-center gap-3">
                    <input 
                        ...
                        name="available" 
                        value="1"
                        @if(old('available', $room->available ?? true)) checked @endif
